...
from network import predictor, compute_corr_loss, compute_corr
import numpy as np
...
data_path='/home/chanae/thesis/train_test_matrices/train.mat'

#path to save model and training results
save_dir='/home/chanae/thesis/nn_train_results/model.ckpt'
save_files='/home/chanae/thesis/nn_train_results/training_output.mat'
...
with tf.Session(config=tf.ConfigProto(allow_soft_placement=True, log_device_placement=True)) as sess:
    ...
    for i in range(epochs):
        ...
        #Averaging results for the all the iterations
